...
const init: GameState = {
  phase:'landing', playerId:null, username:null, quizCode:null, quizTheme:null,
  playerCount:0, currentQuestion:null, currentOptions:[], isMultipleChoice:false,
  questionIndex:0, totalQuestions:0, timeLeft:20,
  hasAnswered:false, selectedIndices:[], answerResult:null,
  leaderboard:[], achievements:[], myScore:0, myRank:0, connected:false, toasts:[],
};
...
export const useGameStore = create<Store>((set, get) => ({
  ...
  setCurrentQuestion: q => set({
    currentQuestion:q, questionIndex:q.questionIndex, totalQuestions:q.totalQuestions,
    isMultipleChoice:q.isMultipleChoice, hasAnswered:false, answerResult:null, selectedIndices:[],
  }),
